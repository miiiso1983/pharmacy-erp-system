                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">
                                <i class="fas fa-user-plus me-2"></i>معلومات المستخدم
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('user_type') is-invalid @enderror" 
                                            ...
                                            <option value="manager" {{ old('user_type') === 'manager' ? 'selected' : '' }}>مدير مساعد</option>
...
function suggestPermissions(userType) {
    ...
    if (suggestedPermissions.length > 0) {
        showNotification(`تم اقتراح ${suggestedPermissions.length} صلاحية لنوع المستخدم: ${userType}`, 'info');
    }
}
